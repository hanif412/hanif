...
type:"POST",
url:"insertdb.php",
data: "nama=" + nama + "&alamat=" + alamat + "&riwayat=" + riwayat + "&hasil=" + hasil + "&tanggal=" + tanggal + "&suhu=" + suhu,
...
<div class="card">
  ...
  <a href="menucovid.php" class="btn btn-primary" class="nav-light" syle="width:80px;">Menu Produk</a>
    <h5 class="text-center"> PASIEN COVID 19 </h5>
  ...
  <div class="card-body">
    ...
    <tr>
        ...
        <td><input type="text" id="riwayat" name="riwayat"></td>
        </tr>
        ...
        <td><input type="number" id="suhu" name="suhu"></td>
        </tr>

        <td></td>
        <td><input type="submit" class="btn btn-primary" class="nav-light"  id="save" value="Save"></tr></td>   
    </table>
